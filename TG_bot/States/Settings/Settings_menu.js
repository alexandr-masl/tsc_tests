...
var Settings_menu = /** @class */ (function () {
    ...
    ;
    Settings_menu.prototype.render = function (ctx) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, ctx.reply('<b>Settings Menu</b>\n', Extra.HTML().markup(function (m) {
                                return m.inlineKeyboard([
                                    [
                                        m.callbackButton('Ok', _this._ok_btn_calbck),
    ...
    ;
    Settings_menu.prototype.callbacks_handler = function (query, ctx) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(query.state_query == "ok")) return [3 /*break*/, 2];
                        return [4 /*yield*/, TG_bot_1.TG_bot.changeState(new Settings_menu(), ctx)];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2:
                        if (!(query.state_query === "back")) return [3 /*break*/, 4];
                        return [4 /*yield*/, TG_bot_1.TG_bot.changeState(new MainMenu_1.MainMenu(), ctx)];
    ...
    ;
    Settings_menu.prototype.messages_handler = function (query, ctx) {
        return __awaiter(this, void 0, void 0, function () {
            var err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ;
    Settings_menu.prototype.test_f = function () {
    };
    ;
